...
namespace ModbusTest
{
    ...
    public class drvCon
    {
       // public AddrMap addr_map; // карта адресов
        ...
        // оси
        private static ushort axisAdr = 30163, andAxisAdr = 3;
        // область энкодера
        ...
        {
            ushort[] tempUSmas = master.ReadHoldingRegisters((ushort)(addr), (ushort)(1));
            return tempUSmas[0];
        }
        ...
        public float twoUshortToFloat(ushort[] value)
        {
        ...
        public int twoUshortToInt(ushort[] value)
        {
            Byte[] q = new Byte[4];
